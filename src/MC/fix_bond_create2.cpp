...
FixBondCreate2::FixBondCreate2(LAMMPS *lmp, int narg, char **arg) :
  Fix(lmp, narg, arg),
...
void FixBondCreate2::init_list(int id, NeighList *ptr)
{
  list = ptr;
}
...
void FixBondCreate2::setup(int vflag)
{
  int i,j,m;
...
void FixBondCreate2::post_integrate()
{
...
void FixBondCreate2::check_ghosts()
{
  int i,j,n;
  tagint *slist;
...
void FixBondCreate2::update_topology()
{
...
void FixBondCreate2::rebuild_special_one(int m)
{
...
void FixBondCreate2::create_angles(int m)
{
...
void FixBondCreate2::create_dihedrals(int m)
{
...
void FixBondCreate2::create_impropers(int m)
{
...
int FixBondCreate2::dedup(int nstart, int nstop, tagint *copy)
{
  int i;
...
void FixBondCreate2::post_integrate_respa(int ilevel, int iloop)
{
...
int FixBondCreate2::pack_forward_comm(int n, int *list, double *buf,
...
void FixBondCreate2::unpack_forward_comm(int n, int first, double *buf)
{
  int i,j,m,ns,last;
...
int FixBondCreate2::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void FixBondCreate2::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void FixBondCreate2::grow_arrays(int nmax)
{
...
void FixBondCreate2::copy_arrays(int i, int j, int delflag)
{
...
int FixBondCreate2::pack_exchange(int i, double *buf)
{
  buf[0] = bondcount[i];
  return 1;
}
...
int FixBondCreate2::unpack_exchange(int nlocal, double *buf)
{
...
double FixBondCreate2::compute_vector(int n)
{
...
double FixBondCreate2::memory_usage()
{
  int nmax = atom->nmax;
...
void FixBondCreate2::print_copy(const char *str, tagint m,
