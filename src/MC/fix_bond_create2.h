...
FixStyle(bond/create,FixBondCreate2)

#else

#ifndef LMP_FIX_BOND_CREATE2_H
#define LMP_FIX_BOND_CREATE2_H

#include "fix.h"

namespace LAMMPS_NS {

class FixBondCreate2 : public Fix {
 public:
  FixBondCreate2(class LAMMPS *, int, char **);
  ~FixBondCreate2();
  int setmask();
  void init();
